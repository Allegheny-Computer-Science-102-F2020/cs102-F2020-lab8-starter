...
* [Laboratory Assignment Tasks](#laboratory-assignment-tasks)
  ...
  + [Implementing a Python Program that Uses Sets to Perform a Containment Check](#implementing-a-python-program-that-uses-sets-to-perform-a-containment-check)
...
- To implement a program that can determine if a word exists inside of a file
- To use the set discrete structure to store the unique words in a file
- To extract the words of a file after first removing all of the punctuation
...
`Allegheny-Computer-Science-102-Fall-2020/computer-science-102-fall-2020-lab-8-gkapfham`.
...
```
git clone git@github.com:Allegheny-Computer-Science-102-F2020/computer-science-102-fall-2020-lab-8-gkapfham.git
```
...
### Implementing a Python Program that Uses Sets to Perform a Containment Check

This assignment invites you to implement a word "containment checker". This
program should first read in a file specified on the command-line, remove the
punctuation from the file, and then store each unique word in the file in a set.
The program should then determine whether or not the word specified on the
command-line exists inside of the specified file. Here is an example of the
program when it determines that the specified word does exist in the file, as it
was run with the following command-line ``
...
Is the specified word one of the unique words in the file? Yes
```

Here is an example of the program output when the word does not exist in the
file, resulting from the following run of the program `poetry run python
containschecker --word Unicorn --data-file inputs/data.txt --display`.
...
You must design the program so that the `contains.py` file has at least two
functions that help to perform the containment check. You should also ensure
that the `test_contains.py` file has at least seven test cases. Finally, your
`__main__.py` file should contain all of the necessary code to create the
command-line interface and the debugging output. With that said, you should not
for instance, define the function that performs the containment check in the
`__main__.py` file. Instead, you should ensure that functions that perform
and/or support the containment check process exist inside of the `contains.py`
file.

### Creating and Running a Test Suite for a Module in a Python Program

This assignment requires you to write at least seven test cases in the file
called `tests/test_contains.py`. You should write tests cases for the functions
in the `contains.py` file, working to ensure that all of the functions work
correctly even when you give them a wide variety of different inputs. For
instance, you should check to make sure that the word containment check works
correctly when (i) you provide it with an empty list of words, (ii) when you
search for a word that does not exist inside of the file, and (iii) when you
search for a word that does exist in the file. Of course, you should test for
any other relevant configurations as well!

```
=========================== test session starts ============================
platform linux -- Python 3.8.5, pytest-5.4.3, py-1.9.0, pluggy-0.13.1
rootdir: /home/gkapfham/working/teaching/github-classroom/Allegheny-Computer-Science-102-F2020/solutions/cs102-F2020-lab8-solution/containschecker
plugins: Faker-4.14.0
collected 7 items

tests/test_contains.py .......                                       [100%]
...
- The command `cd containschecker; poetry install; poetry run python containschecker --word Unicorn --data-file inputs/data.txt --display; cd ..` executes correctly
- The contains.py in containschecker/containschecker has at least 3 multiple-line Python comment(s)
- The contains.py in containschecker/containschecker has at least 4 single-line Python comment(s)
- The contains.py in containschecker/containschecker has exactly 0 of the `TODO` fragment
- The file contains.py exists in the containschecker/containschecker directory
- The file \_\_main\_\_.py exists in the containschecker/containschecker directory
- The file reflection.md exists in the writing directory
- The file test_contains.py exists in the containschecker/tests directory
- The \_\_main\_\_.py in containschecker/containschecker has at least 10 single-line Python comment(s)
- The \_\_main\_\_.py in containschecker/containschecker has at least 2 multiple-line Python comment(s)
- The \_\_main\_\_.py in containschecker/containschecker has exactly 0 of the `TODO` fragment
- The \_\_main\_\_.py in containschecker/containschecker has exactly 1 of the `from pathlib import Path` fragment
- The \_\_main\_\_.py in containschecker/containschecker has exactly 1 of the `run(main)` fragment
- The \_\_main\_\_.py in containschecker/containschecker has exactly 2 of the `Option(...)` fragment
...
- The test_contains.py in containschecker/tests has at least 7 of the `test_` fragment
- The test_contains.py in containschecker/tests has at least 8 multiple-line Python comment(s)
- The test_contains.py in containschecker/tests has exactly 0 of the `TODO` fragment

```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 23/23 (100%) of checks for cs102-F2020-lab8! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-102-F2020/cs102-F2020-lab8-starter.git
```
